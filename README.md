...
| Build and verify a purpose-scoped mental model of unfamiliar material                                   | `prompts/help-me-learn.md`                                       | —                                                               |
...
| Check a stated model by solving independently, then naming its errors and gaps                          | `prompts/correct-me-if-i-am-wrong.md`                            | —                                                               |
...
| Review a branch PR read-only for concrete pre-merge risks and adversarial challenges                    | `prompts/code-review-v2.md`                                      | —                                                               |
| Understand what a pull request changes, why it exists, and how it is used without implementation detail | `prompts/explain-pull-request.md`                                | —                                                               |
...
| Communicate through you as a neutral intermediary between two conflicting parties                       | `prompts/conflict-mediation.md`                                  | —                                                               |
| Sweep and merge green PRs, triage blockers, and update or fix selected PRs across repositories          | `prompts/maintain-my-ci-runs.md`                                 | —                                                               |
| Diagnose and fix failing CI runs on default branches across repositories                                | `prompts/fix-my-failing-ci-runs.md`                              | —                                                               |
...
debugging session and makes it interview the user through dependency-aware clarification rounds.
